            ...
            <div className="space-y-32">
              {exhibitions.map((exhibition, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`group overflow-hidden rounded-xl bg-white shadow-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl ${
                        ...
                        <div className="p-8 lg:w-3/4">
                          <div className="mb-4 flex flex-col lg:flex-row lg:items-start lg:justify-between">
                            <div className="flex-1">
                              <h3 className="mb-2 text-2xl font-bold text-gray-900 transition-colors duration-300 group-hover:text-teal-600">
                                {exhibition.title}
                              </h3>
                              <p className="mb-1 text-lg text-gray-600">{exhibition.venue}</p>
                            </div>
                            <div className="mt-2 lg:mt-0">
                              <span className="inline-block rounded-full bg-teal-600 px-4 py-2 text-sm font-medium text-white transition-colors duration-300 group-hover:bg-teal-700">
                                {exhibition.date}
                              </span>
                            </div>
                          </div>
                          ...
                          {exhibition.link && (
                            <Link
                              ...
                              className="inline-flex items-center rounded-md border border-transparent bg-teal-600 px-6 py-3 text-base font-medium text-white transition-all duration-300 hover:scale-105 hover:bg-teal-700 hover:shadow-lg"
                            >
                              View Details
                              <svg
