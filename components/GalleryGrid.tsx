          ...
          return (
            ...
            >
              <Link
                ...
                className="group relative block break-inside-avoid overflow-hidden rounded-lg bg-gray-100 shadow-lg transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl dark:bg-gray-800"
              >
